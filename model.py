...
training(model=ridge, X_train=X_train, y_train=y_train, X_test=X_test,y_test=y_test)
...
model.fit(X, y)
test_pred = model.predict(test_df["excerpt_preprocessed"])

predictions = pd.DataFrame()
predictions['id'] = test_df['id']
predictions['target'] = test_pred
predictions.to_csv("F:/spyderProjects/CommonLit/CommonLit/submission.csv", index=False)
predictions